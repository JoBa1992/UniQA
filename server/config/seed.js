...
Department.find({}).remove(function() {
  Department.create({
    name: 'Admin',
    subdepartments: ['Admin'],
    deleted: false
  }, {
    name: 'Development and Society',
    subdepartments: ['Natural and Built Environment', 'SIOE', 'Psychology, Sociology and Politics', 'Humanities', 'Law and Criminology', 'TESOL Centre'],
    deleted: false
  }, {
    name: 'ACES',
    subdepartments: ['Computing', 'Engineering and Mathematics', 'SIA', 'Media Arts and Communication'],
    deleted: false
  }, {
    name: 'Health and Wellbeing',
    subdepartments: ['Allied Health Professions', 'Biosciences', 'Nursing and Midwifery', 'Sport and Physical Activity Academy', 'Social Work and Social Care'],
    deleted: false
  }, {
    name: 'Business',
    subdepartments: ['Finance, Accounting and Business Systems', 'Management', 'Service Sector Management'],
    deleted: false
  }, function() {
