					...
					return function() {
						...
						createModal = openModal({
							modal: {
								...
								controller: 'IssueCreateModalCtrl',
								sizePercent: 50,
								dismissable: true,
								fullScreen: true,
								form: 'components/modal/views/issue/create.html',
			...
			delete: {
				...
				module: function(cb) {
					...
					return function() {
						...
						console.info(module);
						$rootScope.moduleToDelete = angular.copy(module);
						deleteModal = openModal({
							modal: {
								name: 'deleteConf',
								dismissable: true,
